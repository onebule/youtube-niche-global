...
const copy = {
  zh: {
    ...
    body: '用公开 YouTube 数据筛选市场、频道与视频，再把值得研究的样本带回自己的工作台。',
    cards: [['实时榜单', '按市场、发布时间和表现读取公开样本'], ['频道研究', '对比播放、订阅与内容形态'], ['保存线索', '把值得研究的视频放进工作台'], ['主人管理', '管理采集、额度与站点运行状态']],
    ledger: '公开数据信号', ledgerState: '不使用演示样本', ledgerRows: ['YouTube 公开数据', '音乐与儿童内容固定排除', '登录用户每天 12 次查询额度'],
  ...
  en: {
    ...
    body: 'Use public YouTube data to narrow markets, channels, and videos, then bring the samples worth studying into your workspace.',
    cards: [['Live rankings', 'Read public samples by market, recency, and performance'], ['Channel research', 'Compare views, subscribers, and video format'], ['Save leads', 'Keep videos worth studying in your workspace'], ['Site administration', 'Review collection, limits, and service status']],
    ledger: 'Public data signals', ledgerState: 'No demo samples', ledgerRows: ['YouTube public data', 'Music and made-for-kids content excluded', 'Signed-in users get 12 queries per day'],
