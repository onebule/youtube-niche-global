...
const copy = {
  zh: {
    ...
    ledger: '公开数据信号', ledgerState: '只显示真实数据', ledgerRows: ['YouTube 公开数据', '影视、音乐、娱乐、游戏与儿童内容固定排除', '登录用户每天 12 次查询额度'],
  ...
  en: {
    ...
    ledger: 'Public data signals', ledgerState: 'Real data only', ledgerRows: ['YouTube public data', 'Film, music, entertainment, gaming, and made-for-kids content excluded', 'Signed-in users get 12 queries per day'],
