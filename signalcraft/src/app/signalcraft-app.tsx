...
function Pricing(){
  ...
  const plans:UpgradePlan[]=[
    {name:'Pro',price:priceFor({month:39,quarter:99,year:299}[cycle]),currency,cycle,description:'个人创作者的真实 YouTube 研究工作流'},
    {name:'Team',price:priceFor({month:299,quarter:849,year:3199}[cycle]),currency,cycle,description:`3 个成员 · 每月 30,000 积分 · AI 图生视频`},
  ];
