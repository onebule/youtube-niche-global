...
export function parseFilters(search:string): { q:string; window:string; language:string; format:string; category:string; maxSubs:string; minScore:string; sort:string };
